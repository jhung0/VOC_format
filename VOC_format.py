...
for train_or_test in ['train', 'text']:
    ...
    #print 'train or test:%s'%train_or_test
    try:
...
for filename in argv[2:]:
    ...
    for object in root.findall('object'):
        ...
        #if IGNORE_EDGE_CELLS is true, skip object
    ...
    for sub in range(num_subimages):
        ...
        filename_annotation = os.path.join(output_dir, 'Annotations',subname+'.txt')
        try:
            os.remove(filename_annotation)
        except OSError:
            pass
